...
// checks if the ProvenanceResultsDTO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProvenanceResultsDTO{}
...
func (o *ProvenanceResultsDTO) GetProvenanceEvents() []ProvenanceEventDTO {
	if o == nil || IsNil(o.ProvenanceEvents) {
