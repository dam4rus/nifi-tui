...
// checks if the ConnectionStatisticsEntity type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConnectionStatisticsEntity{}
...
func (o *ConnectionStatisticsEntity) GetConnectionStatistics() ConnectionStatisticsDTO {
	if o == nil || IsNil(o.ConnectionStatistics) {
...
func (o ConnectionStatisticsEntity) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ConnectionStatistics) {
