...
// checks if the FlowConfigurationEntity type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FlowConfigurationEntity{}
...
func (o *FlowConfigurationEntity) GetFlowConfiguration() FlowConfigurationDTO {
	if o == nil || IsNil(o.FlowConfiguration) {
