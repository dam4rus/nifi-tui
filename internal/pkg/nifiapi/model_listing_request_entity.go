...
// checks if the ListingRequestEntity type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListingRequestEntity{}
...
func (o *ListingRequestEntity) GetListingRequest() ListingRequestDTO {
	if o == nil || IsNil(o.ListingRequest) {
