...
// checks if the PrioritizerTypesEntity type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PrioritizerTypesEntity{}
...
func (o *PrioritizerTypesEntity) GetPrioritizerTypes() []DocumentedTypeDTO {
	if o == nil || IsNil(o.PrioritizerTypes) {
