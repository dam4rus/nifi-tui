...
// checks if the ProcessGroupFlowEntity type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProcessGroupFlowEntity{}
...
func (o *ProcessGroupFlowEntity) GetProcessGroupFlow() ProcessGroupFlowDTO {
	if o == nil || IsNil(o.ProcessGroupFlow) {
