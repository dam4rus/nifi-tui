...
// checks if the ControllerServiceReferencingComponentsEntity type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ControllerServiceReferencingComponentsEntity{}
...
func (o *ControllerServiceReferencingComponentsEntity) GetControllerServiceReferencingComponents() []ControllerServiceReferencingComponentEntity {
	if o == nil || IsNil(o.ControllerServiceReferencingComponents) {
...
func (o ControllerServiceReferencingComponentsEntity) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ControllerServiceReferencingComponents) {
