...
// checks if the ParameterProviderEntity type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ParameterProviderEntity{}
...
// NewParameterProviderEntity instantiates a new ParameterProviderEntity object
...
// NewParameterProviderEntityWithDefaults instantiates a new ParameterProviderEntity object
...
func (o *ParameterProviderEntity) GetComponent() ParameterProviderDTO {
...
type NullableParameterProviderEntity struct {
	value *ParameterProviderEntity
	isSet bool
}

func (v NullableParameterProviderEntity) Get() *ParameterProviderEntity {
	return v.value
}

func (v *NullableParameterProviderEntity) Set(val *ParameterProviderEntity) {
	v.value = val
	v.isSet = true
}

func (v NullableParameterProviderEntity) IsSet() bool {
	return v.isSet
}

func (v *NullableParameterProviderEntity) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableParameterProviderEntity(val *ParameterProviderEntity) *NullableParameterProviderEntity {
	return &NullableParameterProviderEntity{value: val, isSet: true}
}
