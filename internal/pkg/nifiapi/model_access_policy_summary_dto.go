...
// checks if the AccessPolicySummaryDTO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AccessPolicySummaryDTO{}
...
func (o *AccessPolicySummaryDTO) GetComponentReference() ComponentReferenceEntity {
	if o == nil || IsNil(o.ComponentReference) {
