...
// checks if the VersionedFlowsEntity type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VersionedFlowsEntity{}
...
func (o *VersionedFlowsEntity) GetVersionedFlows() []VersionedFlowEntity {
	if o == nil || IsNil(o.VersionedFlows) {
