...
// checks if the ProvenanceSearchableFieldDTO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProvenanceSearchableFieldDTO{}
