...
// checks if the ParameterContextValidationRequestEntity type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ParameterContextValidationRequestEntity{}
