...
// checks if the ProcessorConfigDTO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProcessorConfigDTO{}
...
func (o *ProcessorConfigDTO) GetDefaultConcurrentTasks() map[string]string {
	if o == nil || IsNil(o.DefaultConcurrentTasks) {
		var ret map[string]string
		return ret
	}
...
func (o *ProcessorConfigDTO) GetDefaultSchedulingPeriod() map[string]string {
	if o == nil || IsNil(o.DefaultSchedulingPeriod) {
		var ret map[string]string
		return ret
	}
