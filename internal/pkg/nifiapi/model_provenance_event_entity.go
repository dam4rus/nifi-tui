...
// checks if the ProvenanceEventEntity type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProvenanceEventEntity{}
...
func (o *ProvenanceEventEntity) GetProvenanceEvent() ProvenanceEventDTO {
	if o == nil || IsNil(o.ProvenanceEvent) {
