...
// checks if the VariableRegistryEntity type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VariableRegistryEntity{}
...
func (o *VariableRegistryEntity) GetVariableRegistry() VariableRegistryDTO {
	if o == nil || IsNil(o.VariableRegistry) {
