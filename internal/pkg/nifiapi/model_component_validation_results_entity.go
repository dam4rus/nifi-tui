...
// checks if the ComponentValidationResultsEntity type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ComponentValidationResultsEntity{}
