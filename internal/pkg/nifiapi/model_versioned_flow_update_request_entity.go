...
// checks if the VersionedFlowUpdateRequestEntity type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VersionedFlowUpdateRequestEntity{}
