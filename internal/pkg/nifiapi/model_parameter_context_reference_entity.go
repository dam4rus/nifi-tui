...
// checks if the ParameterContextReferenceEntity type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ParameterContextReferenceEntity{}
