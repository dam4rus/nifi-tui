...
// checks if the ReportingTaskRunStatusEntity type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReportingTaskRunStatusEntity{}
