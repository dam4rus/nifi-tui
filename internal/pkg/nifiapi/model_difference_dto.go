...
// checks if the DifferenceDTO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DifferenceDTO{}
...
func (o *DifferenceDTO) GetDifferenceType() string {
	if o == nil || IsNil(o.DifferenceType) {
		var ret string
		return ret
	}
