...
// checks if the ReportingTaskTypesEntity type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReportingTaskTypesEntity{}
...
func (o *ReportingTaskTypesEntity) GetReportingTaskTypes() []DocumentedTypeDTO {
	if o == nil || IsNil(o.ReportingTaskTypes) {
