...
// checks if the FlowFileDTO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FlowFileDTO{}
...
func (o *FlowFileDTO) GetContentClaimSection() string {
	if o == nil || IsNil(o.ContentClaimSection) {
		var ret string
		return ret
	}
...
func (o *FlowFileDTO) GetContentClaimContainer() string {
	if o == nil || IsNil(o.ContentClaimContainer) {
		var ret string
		return ret
	}
...
func (o *FlowFileDTO) GetContentClaimIdentifier() string {
	if o == nil || IsNil(o.ContentClaimIdentifier) {
		var ret string
		return ret
	}
...
func (o *FlowFileDTO) GetContentClaimOffset() int64 {
	if o == nil || IsNil(o.ContentClaimOffset) {
		var ret int64
		return ret
	}
...
func (o *FlowFileDTO) GetContentClaimFileSize() string {
	if o == nil || IsNil(o.ContentClaimFileSize) {
		var ret string
		return ret
	}
...
func (o *FlowFileDTO) GetContentClaimFileSizeBytes() int64 {
	if o == nil || IsNil(o.ContentClaimFileSizeBytes) {
		var ret int64
		return ret
	}
