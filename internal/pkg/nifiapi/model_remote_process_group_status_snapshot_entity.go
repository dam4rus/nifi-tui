...
// checks if the RemoteProcessGroupStatusSnapshotEntity type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RemoteProcessGroupStatusSnapshotEntity{}
...
func (o *RemoteProcessGroupStatusSnapshotEntity) GetRemoteProcessGroupStatusSnapshot() RemoteProcessGroupStatusSnapshotDTO {
	if o == nil || IsNil(o.RemoteProcessGroupStatusSnapshot) {
...
func (o RemoteProcessGroupStatusSnapshotEntity) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.RemoteProcessGroupStatusSnapshot) {
