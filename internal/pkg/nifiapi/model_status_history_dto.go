...
// checks if the StatusHistoryDTO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StatusHistoryDTO{}
...
func (o *StatusHistoryDTO) GetFieldDescriptors() []StatusDescriptorDTO {
	if o == nil || IsNil(o.FieldDescriptors) {
...
func (o *StatusHistoryDTO) GetAggregateSnapshots() []StatusSnapshotDTO {
	if o == nil || IsNil(o.AggregateSnapshots) {
...
func (o StatusHistoryDTO) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.FieldDescriptors) {
		toSerialize["fieldDescriptors"] = o.FieldDescriptors
	}
	if !IsNil(o.AggregateSnapshots) {
